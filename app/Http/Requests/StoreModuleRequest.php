...
class StoreModuleRequest extends FormRequest
{
    protected function prepareForValidation(): void
    {
        if($this->route('module')==='devis'){
            ...
            $this->merge(['client_name'=>$this->input('client_name')?:$client?->name,'client_contact'=>$this->input('client_contact')?:$client?->contact,'shipping_mode'=>$this->input('shipping_mode')?:'maritime','items'=>$items]);
        }
