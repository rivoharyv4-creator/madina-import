...
class ModuleController extends Controller
{
    ...
    private function fields(string $module): array
    {
        ...
        return match($module){
            ...
            'devis'=>[$select('client_id','Client enregistré',$clients),$input('client_name','Nom du client'),$input('client_contact','Contact du client'),$input('valid_until','Valide jusqu’au','date'),$select('shipping_mode','Mode d’envoi',[['value'=>'maritime','label'=>'Maritime'],['value'=>'aerien','label'=>'Aérien']]),$input('shipping_delay','Délai d’expédition','text',false,'45 à 60 jours'),$select('status','Statut',[['value'=>'brouillon','label'=>'Brouillon'],['value'=>'envoye','label'=>'Envoyé'],['value'=>'negociation','label'=>'Négociation'],['value'=>'accepte','label'=>'Accepté'],['value'=>'refuse','label'=>'Refusé'],['value'=>'sans_reponse','label'=>'Sans réponse'],['value'=>'relance_1','label'=>'Relance 1'],['value'=>'relance_2','label'=>'Relance 2']],true,'brouillon'),$input('bank_details','Informations bancaires / compte bancaire','textarea',false),$input('payment_terms','Conditions de paiement','textarea',false,'50 % à la commande, 50 % à la livraison'),$input('warranty','Garantie','textarea',false),$input('notes','Note / remarque','textarea',false)],
