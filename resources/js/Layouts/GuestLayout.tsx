...
export default function Guest({children}:PropsWithChildren){
 return <div className="grid min-h-screen bg-[#F8F8F6] lg:grid-cols-[1.05fr_.95fr]">
  <section className="relative hidden overflow-hidden bg-[#2F2F2F] p-14 text-white lg:flex lg:flex-col lg:justify-between"><div className="absolute -right-32 -top-32 size-[420px] rounded-full border-[80px] border-[#FCF108]/10"/><Link href="/" className="relative inline-flex w-fit items-center"><BrandLogo className="h-32 w-36"/></Link><div className="relative max-w-lg"><span className="mb-6 block h-1 w-16 rounded bg-[#FCF108]"/><h1 className="text-4xl font-bold leading-tight">Espace de gestion interne</h1><p className="mt-5 text-base leading-relaxed text-white/55">Accès réservé à l’équipe Madina Import pour la gestion sécurisée des activités de l’entreprise.</p></div><p className="text-xs text-white/30">© {new Date().getFullYear()} Madina Import · Madagascar</p></section>
