...
Route::middleware('guest')->group(function () use ($adminLoginPath) {
    ...
    Route::get('authentification-double-facteur', [TwoFactorChallengeController::class, 'create'])
        ->name('two-factor.challenge');
    Route::post('authentification-double-facteur', [TwoFactorChallengeController::class, 'store'])
